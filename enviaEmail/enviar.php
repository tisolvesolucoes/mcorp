...
//enviar 
 ...
 $mail->Username = 'medcorpnet@medcorpnet.com.br'; // Conta de email existente e ativa em seu domínio
 $mail->Password = 'dri031251'; // Senha da sua conta de email
 // DADOS DO REMETENTE
 $mail->Sender = "medcorpnet@medcorpnet.com.br"; // Conta de email existente e ativa em seu domínio
 $mail->From = "medcorpnet@medcorpnet.com.br"; // Sua conta de email que será remetente da mensagem
 $mail->FromName = "medcorpnet.com.br"; // Nome da conta de email
 // DADOS DO DESTINATÁRIO
 $mail->AddAddress('medcorpnet@medcorpnet.com.br', 'Comparativo - site'); // Define qual conta de email receberá a mensagem
 ...
 $mail->Subject = "Comparativo - site"; // Assunto da mensagem
